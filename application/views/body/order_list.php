						...
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
                           ...
                           <?php $no = 0; foreach($dataorder as $row) : $no++;?>
						     <tr>
						        ...
						        <td data-field="id1"><a href="<?php echo base_url();?>daftar_order/view_detail/<?php echo $row->id_pemesanan;?>">ERP<?php echo $row->id_pemesanan;?></a></td>
...
<?php }else {?>
<a  title="Batal Pemesanan" class="hapus btn btn-danger btn-lg" href="<?php echo base_url();?>daftar_order/batal/<?php echo $row->id_pemesanan;?>"><span class="glyphicon glyphicon-ban-circle"></span></a>
<?php }?><a class="ubah btn btn-primary btn-lg" href="<?php echo base_url();?>order/edit/<?php echo $row->id_pemesanan;?>"><span class="glyphicon glyphicon-edit" ></span></a>
<?php }?>
</td>
