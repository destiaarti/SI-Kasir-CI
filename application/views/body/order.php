...
<div class="row">
 ...
 <div class="col-sm-4">
   <div class="input-group">
    ...
    <input id="msg" type="text" class="form-control" name="nama_pemesan" required placeholder="Nama Pemesan">
  </div>
...
<ul class="nav nav-tabs">
  ...
  <div class="tab-content">
    ...
    <tbody>
    	<?php $no=0; foreach($dataproduk_makanan as $row_makanan) {
		if($row_makanan->aktif==1){	
		 $no++;?>
      <tr>
      	<td><?php echo $no;?></td>
    ...
    <tbody>
    	<?php $noo=$no; foreach($dataproduk_minuman as $row_minuman) {
			if($row_minuman->aktif==1){	 $noo++;?>
      <tr>
      	<td><?php echo $noo;?></td>
